...
namespace WebUI4CSharp_net48
{
    ...
    public class WebUIWindow
    {
        ...
        {
            // Convert UIntPtr to ulong for comparison
            ulong windowIdValue = windowId.ToUInt64();

            if (windowIdValue > 0 && windowIdValue < WebUI.WEBUI_MAX_IDS)
            {
        ...
        /// </summary>
        public bool Initialized { get => Id.ToUInt64() > 0; }
